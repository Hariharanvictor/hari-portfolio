...
import "./about.css";
import fullTime from "../assest/Middle - Fill.png";
import Header from "../Header/Header";
import internship from '../assest/intern.png'
...
const About = () => {
  ...
  const education = [
    {
      role: "Bachelor in Electronics & Communication",
  ...
  return (
    <div className="about-div">
      ...
      <div className="container con-div">
        <h2 className="about-heading d-flex justify-content-start ms-5">
          About Me
        </h2>
        <p className="d-flex justify-content-start about-me">
        Aspiring Front-End Developer with hands-on experience in developing interactive and responsive websites. Proficient in technologies like React, JavaScript, Angular, Bootstrap and CSS. Actively seeking opportunities to contribute to upcoming projects, where I can apply my skills in a dynamic team environment and further advance my expertise in web development.
        </p>
      </div>
      <div className="container">
        <h2 className="about-experience d-flex justify-content-start ms-5">
          Work Experience
        </h2>
        <div className="row">
          {experience.map((data) => {
            return (
              <div className="d-flex flex-row ms-5 pt-3 " >
                <div className="col-md-8">
                  <div>
                    <h3 className="about-role">{data.role}</h3>
                  </div>
                  <div className="d-flex flex-row">
                    ...
                    <p className="me-5 about-company">{data.name}</p>
                    <svg
                      width="16"
                      height="12"
                      viewBox="0 0 16 12"
                    ...
                    <div>
                      <p className="about-location d-flex  flex-row justify-content-end align-items-center">
                        {data.location}
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-md-4">
                  ...
                  <div className="d-flex flex-row">
                    ...
                    <p className="about-period">{data.period}</p>
                  </div>
                </div>
